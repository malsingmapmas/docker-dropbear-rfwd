...
#define DSS_PRIV_FILENAME "/keys/dropbear_dss_host_key"
#define RSA_PRIV_FILENAME "/keys/dropbear_rsa_host_key"
#define ECDSA_PRIV_FILENAME "/keys/dropbear_ecdsa_host_key"
#define ED25519_PRIV_FILENAME "/keys/dropbear_ed25519_host_key"
